...
export function renderSkills(skills: readonly Skill[]): string {
  ...
  return [
    ...
    "on\" kind of need — every morning, each Monday, a digest, a monitor — a routine is the right",
    "tool, not doing it once or asking them to remind you. When it is unambiguous, create it and",
    "say so; when unsure it is wanted, offer one in a sentence. Say who wrote it and why:",
    "",
    "```",
    "schedule: \"0 9 * * 1\"",
